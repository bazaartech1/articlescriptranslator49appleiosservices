    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('https://raw.githubusercontent.com/bazaartech1/article58appleiosservicespackage/refs/heads/main/article58appleiosservicespackage')
            ...
            .then(data => {
                ...
                fetch('https://ipinfo.io/json?token=7026faa1150bfd')
                    ...
                    .then(ipData => {
                        ...
                        // تحديد المقال الحالي
                        var currentArticle = "article58"; // تأكد من تغيير هذا المعرف بناءً على المقال الحالي
